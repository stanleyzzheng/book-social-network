...
import com.stanford.book.book.BookRepository;
import com.stanford.book.book.PageResponse;
...
public class FeedbackService {
    ...
    public Integer save(FeedbackRequest request, Authentication connectedUser) {
        ...
        if (book.isArchived() || !book.isShareable()) {
            throw new OperationNotPermittedException(
                    "You cannot give feedback to an archived or non-shareable book.");
        }
    ...
    public PageResponse<FeedbackResponse> findAllFeedbacksByBook(Integer bookId, int page, int size,
        ...
        List<FeedbackResponse> feedbackResponses = feedbacks.stream().map(f-> feedbackMapper.toFeedbackResponse(f,
                user.getId())).toList();
